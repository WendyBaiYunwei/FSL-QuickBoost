...
import numpy as np
import task_generator_val as tg
import math
import argparse
...
def main():
    ...
    for episode in range(EPISODE):
        ...
        # sample datas
        samples,sample_labels,support_names = sample_dataloader.__iter__().next() 
        batches,batch_labels,qry_names  = batch_dataloader.__iter__().next()
        ...
        relation_pairs = torch.cat((sample_features_ext,batch_features_ext),2).view(-1,FEATURE_DIM*2,19,19) #19,19
        ...
        if episode%5000 == 0:
            ...
            for i in range(TEST_EPISODE):
                ...
                for test_images,test_labels,qry_names in test_dataloader:
                    ...
                    counter += len(rewards)
            test_accuracy = total_rewards / counter
            ...
            if test_accuracy > last_accuracy:
                ...
                # save networks
                torch.save(feature_encoder.state_dict(),"./models/" + params['name'] + "_feature.pkl")
                torch.save(relation_network.state_dict(),"./models/" + params['name'] +"_relation.pkl")
